...
Install Filtering Rules
    ...
    $ ./do_request_from_file.sh {certPath} POST '{href}/data/ietf-dots-data-channel:dots-data/dots-client=123?insert=first' sampleAcl.json

    Post acl with insert and point:
    $ ./do_request_from_file.sh {certPath} POST '{href}/data/ietf-dots-data-channel:dots-data/dots-client=123?insert=after&point=xxx' sampleAcl.json
    ...
    Put acl with insert:
    $ ./do_request_from_file.sh {certPath} PUT '{href}/data/ietf-dots-data-channel:dots-data/dots-client=123/acls/acl=xxx?insert=last' sampleAcl.json

    Put acl with insert and point:
    $ ./do_request_from_file.sh {certPath} PUT '{href}/data/ietf-dots-data-channel:dots-data/dots-client=123/acls/acl=xxx?insert=before?point=xxx1' sampleAcl.json
...
Create vendor-mapping
    ...
    $ ./do_request_from_file.sh {certPath} POST {href}/data/ietf-dots-data-channel:dots-data/dots-client=123 sampleVendorAttackMapping.json

Update vendor-mapping

    $ ./do_request_from_file.sh {certPath} PUT {href}/data/ietf-dots-data-channel:dots-data/dots-client=123/ietf-dots-mapping:vendor-mapping/vendor-id=345 sampleVendorAttackMapping.json

Get vendor-mapping of server

    $ ./do_request_from_file.sh {certPath} GET {href}/data/ietf-dots-data-channel:dots-data/ietf-dots-mapping:vendor-mapping

Get vendor-mapping

    Get vendor-mapping with 'depth'
    $ ./do_request_from_file.sh {certPath} GET {href}/data/ietf-dots-data-channel:dots-data/dots-client=123/ietf-dots-mapping:vendor-mapping?depth=3

    Get vendor-mapping with 'content'
    $ ./do_request_from_file.sh {certPath} GET {href}/data/ietf-dots-data-channel:dots-data/dots-client=123/ietf-dots-mapping:vendor-mapping?content=all
...
Delete vendor-mapping
    ...
    $ ./do_request_from_file.sh {certPath} DELETE {href}/data/ietf-dots-data-channel:dots-data/dots-client=123/ietf-dots-mapping:vendor-mapping/vendor-id=345

    Delete all vendor-mapping
    $ ./do_request_from_file.sh {certPath} DELETE {href}/data/ietf-dots-data-channel:dots-data/dots-client=123/ietf-dots-mapping:vendor-mapping
