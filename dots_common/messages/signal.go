...
type Scope struct {
	...
	ClientIdentifier string `json:"cuid" codec:"4,omitemoty"`
	// Identifier for the mitigation request
	MitigationId int `json:"mid" codec:"5,omitemoty"`
	// prefix
...
type SignalConfigRequest struct {
	_struct bool `codec:",uint"`        //encode struct with "unsigned integer" keys
	SignalConfig SignalConfig `json:"ietf-dots-signal-channel:signal-config" codec:"30"`
}
...
type SignalConfig struct {
	...
	SessionId int `json:"sid" codec:"31"`
