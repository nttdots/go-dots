 ...
 */
func init() {
	register(MITIGATION_REQUEST, REQUEST, coap.NonConfirmable, SIGNAL, "mitigation_request", ".well-known/dots/v1/mitigate", MitigationRequest{})
	register(SESSION_CONFIGURATION, REQUEST, coap.NonConfirmable, SIGNAL, "session_configuration", ".well-known/dots/v1/config", SignalConfigRequest{})
