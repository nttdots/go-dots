 ...
 */
func init() {
	register(MITIGATION_REQUEST, REQUEST, coap.NonConfirmable, SIGNAL, "mitigation_request", ".well-known/v1/dots-signal/signal", MitigationRequest{})
	register(SESSION_CONFIGURATION, REQUEST, coap.NonConfirmable, SIGNAL, "session_configuration", ".well-known/v1/dots-signal/config", SignalConfig{})
