...
func notFoundHandler(l net.Conn, a net.Addr, m *Message) *Message {
	if m.IsConfirmable() {
		return &Message{
...
func (mux *ServeMux) ServeCOAP(l net.Conn, a net.Addr, m *Message) *Message {
...
func (mux *ServeMux) HandleFunc(pattern string,
	f func(l net.Conn, a net.Addr, m *Message) *Message) {
