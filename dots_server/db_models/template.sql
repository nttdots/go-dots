...
####### Basically this table is modified by the system only.
#  id: id of this login profile.
#  customer_id: id of the customer this parameter corresponds to.
#  identifier_id: id of the customer identifier. if this parameter is not for an identifier, set this field to '0'.
#  mitigation_scope_id: id of a mitigation scope the customer requested. if this parameter is not for a mitigation scope, set this field to '0'. Note that this id is not the 'mitigation_id', but the database id.
#  type: type of this parameter. these are based on drafts of the data channel and the signal channel.
#   'TARGET_PROTOCOL','FQDN','URI','E_164','TRAFFIC_PROTOCOL','ALIAS'
...
####### Basically the table 'prefix' is modified by the system only.
